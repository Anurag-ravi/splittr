...
class _$ActivityModelImpl extends _ActivityModel {
  ...
  @override
  String toString() {
    return 'ActivityModel(id: $id, entityId: $entityId, entityType: $entityType, title: $title, createdAt: $createdAt, read: $read, category: $category, net: $net, subtitle: $subtitle)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, entityId, entityType, title,
      createdAt, read, category, net, subtitle);
...
abstract class _ActivityModel extends ActivityModel {
  const factory _ActivityModel(
      ...
      final String? category,
      final String? net,
      final String? subtitle}) = _$ActivityModelImpl;

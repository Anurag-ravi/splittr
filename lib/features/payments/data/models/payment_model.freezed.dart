...
abstract class $PaymentModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @HiveField(4) String by,
      @HiveField(5) String to});
}
...
class _$PaymentModelImpl extends _PaymentModel {
  const _$PaymentModelImpl(
      ...
      @HiveField(4) required this.by,
      @HiveField(5) required this.to})
      : super._();
  ...
  @override
  String toString() {
    return 'PaymentModel(id: $id, trip: $trip, amount: $amount, created: $created, by: $by, to: $to)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, trip, amount, created, by, to);
...
abstract class _PaymentModel extends PaymentModel {
  const factory _PaymentModel(
      ...
      @HiveField(4) required final String by,
      @HiveField(5) required final String to}) = _$PaymentModelImpl;

...
class Boxes {
  ...
  static Box<PaymentModel> getPayments() =>
      Hive.box<PaymentModel>('payments');

  static Box<ShortTripModel> getShortTrips() =>
      Hive.box<ShortTripModel>('shorttrips');

  static Box<TripModel> getTrips() =>
      Hive.box<TripModel>('trips');

  static Box<TripUser> getTripUsers() =>
      Hive.box<TripUser>('tripusers');
